...
*/
 // console.log("Bridge check: " + radiationLevel);            // radiationLevel is not defined
...
*/
 //console.log(sectorMessage);     //sectorMessage is not defined    since it is block-scoped
...
console.log(`Left over water: ${totalWaterReserves}t `);